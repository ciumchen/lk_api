...
Route::post('yttest1', 'Test\YuntongController@index');
Route::post('yttest2', 'Test\YuntongController@index');
Route::post('yttest3', 'Test\YuntongController@index');
Route::post('yttest4', 'Test\YuntongController@index');
