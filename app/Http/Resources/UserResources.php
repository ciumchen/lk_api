...
class UserResources extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $userLevelRelation = UserLevelRelation::whereUserId($user->id)->first();
        $LevelName = UserLevel::getLevelText($userLevelRelation->level_id ?? 0);
        return [
            'id'                       => $this->id,
            'phone'                    => $this->phone,
            'role'                     => $this->role,
            ...
            'level_id'                 => $userLevelRelation->level_id ?? 0,
