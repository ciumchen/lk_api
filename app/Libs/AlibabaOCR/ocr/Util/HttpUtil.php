...
class HttpUtil
{
     ...
     *请求Request
     */
    private static function DoHttp(
        $host,
        $path,
        $method,
        $appKey,
        ...
        $headers = self::InitialBasicHeader($path, $appKey, $appSecret, $method, $headers, $querys, $bodys,
                                            $signHeaderPrefixList);
     ...
     *准备请求的基本header
     */
    private static function InitialBasicHeader(
        $path,
        $appKey,
        $appSecret,
        $method,
        ...
        $headers[ SystemHeader::X_CA_SIGNATURE ] = SignUtil::Sign($path, $method, $appSecret, $headers, $querys, $bodys,
                                                                  $signHeaderPrefixList);
        return $headers;
    }
