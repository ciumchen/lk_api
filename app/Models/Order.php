...
class Order extends Model
{
    ...
    public function upUsers(array $data)
    {
        ...
        } else
        {
            ...
            Log::info('============', ['lk' => $uintegral / 300]);
            Log::info('++++++++++++', ['lk' => $sintegral / 300]);
    ...
    public function getPast(string $status, int $oid)
    {
        ...
        try{
            ...
            if($status == 2)
            {
                ...
                //$customer->save();
                DB::table('user')->where('id', $order->uid)->update(['integral' => $customer->integral, 'lk' => $customer->lk]);
                ...
                Log::info('============', ['business' => $business->business_lk]);
                $business->save();
